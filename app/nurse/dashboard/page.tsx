        ...
        <ul>
          {shifts.map((rosterItem) => (
            <li key={rosterItem.id} className="mb-2 p-2 rounded-lg bg-white/10">
              ...
              <p>
                <strong>Shift:</strong> {rosterItem.shift.name} (
                {rosterItem.shift.shiftType})
              </p>
              <p>
                <strong>Time:</strong>{" "}
                {new Date(rosterItem.shift.startTime).toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit",
                })}{" "}
                -{" "}
                {new Date(rosterItem.shift.endTime).toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </p>
